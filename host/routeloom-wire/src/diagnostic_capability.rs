...
//!
//! Bit 7 (route broadcast) was never assigned before P5-2, so legacy peers
//! grant nothing there; a group tag cannot upgrade a peer's capability grant.

pub const CAP_RRS_GOSSIP_V1: u32 = 1 << 5;
pub const CAP_MEMBERSHIP_LIFECYCLE_V1: u32 = 1 << 6;
pub const CAP_ROUTE_BROADCAST_V1: u32 = 1 << 7;
