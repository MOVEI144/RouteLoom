...
[Issues #14・#16・#17の仕様・実装計画](design/scope-gateway-config/README.md)：Scope filter、指定Gateway/Host受領、認可された小設定更新。Wire/API宣言案、資源計算、失敗状態、設計例と46件の未実行受入ケースを含む。runtime実装・本番認証・実機資格の完了とは分けて読む。
