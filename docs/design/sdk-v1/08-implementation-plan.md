...
P0は他と独立して先に出せる。P0-1／P0-2とP1-1〜P1-5、P2-1、P2-3、P3-3（USB結線を除く）、P4-1、P7-1（保守verbを除く）はこのbranchに含まれる。
